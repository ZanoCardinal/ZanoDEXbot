...
public class StatusEndpoint {
    ...
    public ResponseEntity<MmStatusResponse> getMmStatus() {
        try {
            ...
            statusResponse.setFloatTokenAssetId((String) ApplicationStartup.getConfig("tokenAssetId"));
            ...
            BigDecimal issuedTokens = new BigDecimal(ZanoWalletService.getFloatTokensDataMain().getAsset_info().getCurrent_supply()).
            ...
            BigDecimal marketMakerWalletBalanceZano = new BigDecimal(ZanoWalletService.getZanoDataMain().getTotal()).
            ...
            BigDecimal marketMakerWalletBalanceFloat = new BigDecimal(ZanoWalletService.getFloatTokensDataMain().getTotal()).
                    movePointLeft(ZanoWalletService.getFloatTokensDataMain().getAsset_info().getDecimal_point());
